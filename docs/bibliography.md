# Historical Dance: A Bibliography
...
Все транскрипции хранятся в формате [`markdown`](http://daringfireball.net/projects/markdown/syntax), дополнительно включёны расширения [footnotes](http://pythonhosted.org/Markdown/extensions/footnotes.html), [tables](http://pythonhosted.org/Markdown/extensions/tables.html).
